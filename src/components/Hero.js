      ...
      <section className="hero">
         <div className="hero-header">
            ...
            <p className="hero-desc">
               My name is Axl Nuñez, I'm a Marine Corps veteran and a student at
               Montclair State University, New Jersey. Currently, I am pursuing
               a dual degree in Computer Science. Additionally, I am an
               experienced Full-Stack Software Engineer, I build web
